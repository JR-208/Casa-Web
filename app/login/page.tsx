      ...
      <div style={{ width: '100%', maxWidth: '360px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            border: '1px solid #E5E0D8', borderRadius: '18px',
        ...
        <div style={{
          ...
          <form action={formAction}>
            <label style={{
              ...
              color: '#5C5850', marginBottom: '8px',
            }}>
              PIN de acceso
            </label>
            <input
              name="pin" type="password" inputMode="numeric"
              maxLength={8} required placeholder="••••" autoFocus
              style={{
                width: '100%', padding: '12px 16px', fontSize: '22px',
                textAlign: 'center', letterSpacing: '0.3em',
                border: '1px solid #E5E0D8', borderRadius: '12px',
                outline: 'none', background: '#FAFAF8', color: '#1A1814',
            ...
            {state?.error && (
              <p style={{
                ...
                background: '#FEF0EE', borderRadius: '8px',
              }}>{state.error}</p>
            )}
